...
| [eclipse-plugin-nls-qa.md](eclipse-plugin-nls-qa.md) | — | プラグインの文言を英語（既定）と日本語で出し分ける。Pleiades が訳してくれない理由、Java 8 の properties の文字コードの罠、NLS / ResourceBundle を使わなかった理由、訳し忘れの検査 |
