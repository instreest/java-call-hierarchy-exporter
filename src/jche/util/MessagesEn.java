...
final class MessagesEn {
    ...
    private static String[] exporter() {
        return new String[] {
            ...
            "exporter.warnings.incomplete.remedy2", "If the row limit (max.rows) was reached, raise it or narrow the entry points with entry.packages. The same limit also applies to the constructor calls and excluded methods the walk passes without writing rows.",
    ...
    private static String[] report() {
        return new String[] {
            ...
            "report.walker.maxSilentNodes", "The walk passed {0} constructor calls and excluded methods (exclude.packages), which are not written as rows, so the output stops here. This uses the same limit as max.rows",
