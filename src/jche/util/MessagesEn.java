...
final class MessagesEn {
    ...
    private static String[] analysis() {
        return new String[] {
            ...
            "analysis.batchRetry", "The remaining {0} file(s), {1} included, are analyzed again together, with the other files of the folder of {1} and the files whose names it contains (imports and qualified names) added",
            "analysis.batchSetAside", "{0} is set aside and analyzed on its own, because the Java parser stopped there even with the files related to it added; the other {1} file(s) of the batch continue together",
