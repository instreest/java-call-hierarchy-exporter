...
final class MessagesEn {
    ...
    private static String[] analysis() {
        return new String[] {
            ...
            "analysis.batchFailed", "The Java parser failed in a batch before returning {0} ({2}). That file is set aside and analyzed again with the other files of its folder and the files it imports; the other {1} file(s) of the batch continue together",
            "analysis.batchTooDeep", "The Java parser ran out of stack in a batch before returning {0}. That file is set aside and analyzed again with the other files of its folder and the files it imports (only a file that is too deep fails); the other {1} file(s) of the batch continue together",
            "analysis.batchStopped", "The Java parser stopped in a batch without an error before returning {0}. That file is set aside and analyzed again with the other files of its folder and the files it imports; the other {1} file(s) of the batch continue together",
