...
final class MessagesEn {
    ...
    private static String[] analysis() {
        return new String[] {
            ...
            "analysis.cache.incompatible", "[cache] The format, source level, encoding, JDK, JDT or source folder order differs, so the existing cache is discarded",
    ...
    private static String[] graph() {
        return new String[] {
            ...
            "graph.duplicateType", "The type {0} is declared in both {1} and {2} (the same class in two source folders). Only one of them can be analyzed; the calls of the other are missing from the output. Methods are attributed to {3}. Remove the duplicate, or list only one of the folders in source.folders",
